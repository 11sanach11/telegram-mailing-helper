<div id="dispatch-group-info">
    <ul class="u-text u-text-1">
        ...
        <li>Показывать блок только для пользователей с tgId: (tgId через запятую): <span id="show_group_only_for-group-info">{{data["info"].show_group_only_for}}</span> -> <a href="#a" onclick="editObject('show_group_only_for','show_group_only_for-group-info', {{data["info"].id}})">Редактировать</a></li>
